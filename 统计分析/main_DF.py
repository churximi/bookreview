...
"""
功能：综合主程序，利用DF选特征词，并获取句子的各种向量表示
输入：分词文本、特征词个数、句子类别文本
输出：句子向量表示的二值法、TF法、TF-IDF法
时间：2016年5月17日 21:40:42
"""

import tkFileDialog
from Functions.TextSta import TextSta
from Functions import FeatureWords
